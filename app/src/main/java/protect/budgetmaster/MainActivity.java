...
import protect.budgetmaster.intro.IntroActivity;
...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        SharedPreferences prefs = getSharedPreferences("protect.budgetmaster", MODE_PRIVATE);
    ...
    private void displayAboutDialog()
    {
        ...
        String html =
            ...
            "<img src=\"file:///android_res/mipmap/app_logog\" alt=\"" + appName + "\"/>" +
            "<h1>" +
