...
public class MainActivityTest
{
    ...
    public void setUp()
    {
        ...
        prefs = RuntimeEnvironment.application.getSharedPreferences("protect.budgetmaster", Context.MODE_PRIVATE);
    ...
    {
        testItemClickLaunchesActivity(0, "protect.budgetmaster/.BudgetActivity");
    }

    @Test
    public void clickOnTransactions()
    {
        testItemClickLaunchesActivity(1, "protect.budgetmaster/.TransactionActivity");
    }
    ...
    public void testClickSettings()
    {
        ...
        testNextStartedActivity(activity, "protect.budgetmaster/.SettingsActivity");
    }
    ...
    public void testClickImportExport()
    {
        ...
        testNextStartedActivity(activity, "protect.budgetmaster/.ImportExportActivity");
    }
    ...
    public void testFirstRunStartsIntro()
    {
        ...
        assertEquals("protect.budgetmaster/.intro.IntroActivity", name);
